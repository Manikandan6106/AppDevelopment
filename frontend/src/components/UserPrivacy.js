...
import '../styling/UserPrivacy.css'; // Import CSS if you have specific styles for this component
import UserNavbar from './UserNavbar';
 
const UserPrivacy = () => {
  return (
    <div className="uprivacy-policy">
      <UserNavbar />
      <div className="uprivacy-policy-container">
        <h1 className="uprivacy-policy-title">Privacy Policy</h1>
        <p className="uprivacy-policy-intro">
        ...
        <section className="uprivacy-policy-section">
